		...
		options: [
			...
			},
			{
				...
				options: [
					...
					{ name: 'Ash', value: 'Ash' },
					{ name: 'Ashrose', value: 'Ashrose' },
					{ name: 'Atacama', value: 'Atacama' },
					{ name: 'Atmosphere', value: 'Atmosphere' },
					{ name: 'Aurora', value: 'Aurora' },
					{ name: 'Aurum', value: 'Aurum' },
					{ name: 'Basic Dark', value: 'Basic Dark' },
					{ name: 'Basic Light', value: 'Basic Light' },
					{ name: 'Bee Happy', value: 'Bee Happy' },
					{ name: 'Blue Steel', value: 'Blue Steel' },
					{ name: 'Blueberry', value: 'Blueberry' },
					{ name: 'Blues', value: 'Blues' },
					{ name: 'Bonan Hale', value: 'Bonan Hale' },
					{ name: 'Borealis', value: 'Borealis' },
					{ name: 'Breeze', value: 'Breeze' },
					{ name: 'Bubble Gum', value: 'Bubble Gum' },
					{ name: 'Canaveral', value: 'Canaveral' },
					{ name: 'Chimney Dust', value: 'Chimney Dust' },
					{ name: 'Chimney Smoke', value: 'Chimney Smoke' },
					{ name: 'Chisel', value: 'Chisel' },
					{ name: 'Chocolate', value: 'Chocolate' },
					{ name: 'Cigar', value: 'Cigar' },
					{ name: 'Clementa', value: 'Clementa' },
					{ name: 'Coal', value: 'Coal' },
					{ name: 'Commons', value: 'Commons' },
					{ name: 'Consultant', value: 'Consultant' },
					{ name: 'Coral Glow', value: 'Coral Glow' },
					{ name: 'Cornfield', value: 'Cornfield' },
					{ name: 'Cornflower', value: 'Cornflower' },
					{ name: 'Creme', value: 'Creme' },
					{ name: 'Daktilo', value: 'Daktilo' },
					{ name: 'Dawn', value: 'Dawn' },
					{ name: 'Daydream', value: 'Daydream' },
					{ name: 'Default', value: 'Default' },
					{ name: 'Dialogue', value: 'Dialogue' },
					{ name: 'Dune', value: 'Dune' },
					{ name: 'Editoria', value: 'Editoria' },
					{ name: 'Electric', value: 'Electric' },
					{ name: 'Elysia', value: 'Elysia' },
					{ name: 'Finesse', value: 'Finesse' },
					{ name: 'Flamingo', value: 'Flamingo' },
					{ name: 'Flax', value: 'Flax' },
					{ name: 'Fluo', value: 'Fluo' },
					{ name: 'Founder', value: 'Founder' },
					{ name: 'Gamma', value: 'Gamma' },
					{ name: 'Gamma Dark', value: 'Gamma Dark' },
					{ name: 'Gleam', value: 'Gleam' },
					{ name: 'Gold Leaf', value: 'Gold Leaf' },
					{ name: 'Howlite', value: 'Howlite' },
					{ name: 'Icebreaker', value: 'Icebreaker' },
					{ name: 'Incandescent', value: 'Incandescent' },
					{ name: 'Indigo', value: 'Indigo' },
					{ name: 'Iris', value: 'Iris' },
					{ name: 'Keepsake', value: 'Keepsake' },
					{ name: 'Kraft', value: 'Kraft' },
					{ name: 'Lavender', value: 'Lavender' },
					{ name: 'Leimoon', value: 'Leimoon' },
					...
					{ name: 'Moss & Mist', value: 'Moss & Mist' },
					{ name: 'Mystique', value: 'Mystique' },
					{ name: 'Nebulae', value: 'Nebulae' },
					{ name: 'Night Sky', value: 'Night Sky' },
					{ name: 'Nova', value: 'Nova' },
					{ name: 'Oasis', value: 'Oasis' },
					{ name: 'Oatmeal', value: 'Oatmeal' },
					...
					{ name: 'Plant Shop', value: 'Plant Shop' },
					...
					{ name: 'Stratos', value: 'Stratos' },
					{ name: 'Terracotta', value: 'Terracotta' },
					{ name: 'Tranquil', value: 'Tranquil' },
					{ name: 'Twilight', value: 'Twilight' },
					{ name: 'Vanilla', value: 'Vanilla' },
					{ name: 'Velvet Tides', value: 'Velvet Tides' },
					{ name: 'Verdigris', value: 'Verdigris' },
